...
CREATE POLICY "All authenticated users" ON "public"."orders" TO "authenticated" USING (true) WITH CHECK (true);



CREATE POLICY "Allow authenticated users" ON "public"."order_items" TO "authenticated" USING (true) WITH CHECK (true);
